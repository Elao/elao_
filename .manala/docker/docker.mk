...
# Services
MANALA_DOCKER_SERVICES ?= $(MANALA_DOCKER_DEFAULT_SERVICES)
MANALA_DOCKER_COMPOSE_FILE += $(foreach SERVICE, $(MANALA_DOCKER_SERVICES), \
	$(if $(findstring $(SERVICE), $(MANALA_DOCKER_DEFAULT_SERVICES)), \
		$(MANALA_DIR)/.manala/docker/services/$(SERVICE)/compose.yaml \
	) \
)
