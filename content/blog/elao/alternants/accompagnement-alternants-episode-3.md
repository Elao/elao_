...
date: '2025-01-15' # Au format YYYY-MM-DD
...
Tout d’abord, nous laissons notre nouvel·lle arrivant·e s’adapter à son environnement après son premier jour au sein de
l’agence, mais nous faisons un point en fin de semaine afin de prendre en considération ses premières impressions :
est-ce que cette première semaine s’est bien déroulée ? Est-ce qu’il/elle commence à te sentir plus à l’aise ? Est-ce
...
rapport d’étonnement et sur les autres documents qu’il aura pu remplir (le test de Kolb, les facteurs de motivation).
...
- Un premier onglet général qui va nous permettre d’avoir une vue d’ensemble des retours de l’alternant avec un tableau
  récapitulatif.
- Un second onglet qui nous donne une vue générale sous forme de graph dynamiques.
- Un onglet par entretien de suivi dans lequel il répond à des questions récurrentes via un système de notation (via une
  météo, des chiffres, des niveaux de satisfaction) et à des questions que nous préparons en amont, en lien avec sa
  formation.

Le but est de remplir ce document avec le tutoré, c’est pourquoi il est projeté lors de l’entretien de suivi, afin que
...
Vous l’aurez compris, l’objectif de ces suivis est de s’assurer que l’alternant se sente en phase avec ses missions, à
l’aise au sein de l’agence et que l’on réponde bien à ses attentes. C’est donc à nous, accompagnant, de veiller à faire
remonter les **points de frictions** éventuels afin qu’ils puissent être résolus et que la situation ne se dégrade
davantage. C’est également l’occasion de noter les bonnes pratiques et les valoriser.
Pour cela, lorsque nous avons fait passer les entretiens de suivi pour l’ensemble de nos alternants, nous faisons un
...
Lorsque la fin du cycle approche, nous préparons un **entretien de fin de cycle**. Ce dernier a pour but de clôturer le
...
- Un premier document que nous transmettons à notre alternant·e et qu’il/elle devra compléter pour l’entretien. Ce
  ...
  *savoir-faire** et **savoir-être**.
  On lui demande entre autre  :
    ...
    - comment il/elle se situe sur une liste de soft skils
    ...
    - l’ambiance au sein de l’agence, sa relation avec son/ses tuteur·s
      On lui demande également de choisir un TOP et un FLOP afin de clôturer ce document.


- Du côté des tuteurs, un support est également mis en place pour fournir un retour à l'alternant. Nous partageons
  d'abord un feedback à la fois général et personnalisé, puis nous complétons le tableau des **soft skills** pour
  comparer nos évaluations. Cela permet souvent de mettre en évidence les écarts entre l'image que l'alternant a de
  lui-même et celle perçue par les autres.
